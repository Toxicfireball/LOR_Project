# Generated by Django 5.1.6 on 2025-06-18 16:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='rulebook_images/')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ability', models.CharField(choices=[('strength', 'Strength'), ('dexterity', 'Dexterity'), ('constitution', 'Constitution'), ('intelligence', 'Intelligence'), ('wisdom', 'Wisdom'), ('charisma', 'Charisma')], default='strength', help_text='Primary governing ability', max_length=12)),
                ('secondary_ability', models.CharField(blank=True, choices=[('strength', 'Strength'), ('dexterity', 'Dexterity'), ('constitution', 'Constitution'), ('intelligence', 'Intelligence'), ('wisdom', 'Wisdom'), ('charisma', 'Charisma')], help_text='Optional secondary governing ability', max_length=12, null=True)),
                ('selection_mode', models.CharField(choices=[('all', 'Grant all SubSkills'), ('pick_one', 'Let user pick one SubSkill')], default='all', help_text='On the character sheet: grant every subskill, or let them pick one?', max_length=10)),
                ('description', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(blank=True, help_text='Background Summary:', null=True)),
                ...
                ('primary_skill_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='Primary Skill/SubSkill ID')),
                ...
                ('secondary_skill_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='Secondary Skill/SubSkill ID')),
                ('primary_skill_type', models.ForeignKey(blank=True, limit_choices_to=models.Q(('app_label', 'characters'), ('model__in', ['skill', 'subskill'])), null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='contenttypes.contenttype')),
                ('secondary_skill_type', models.ForeignKey(blank=True, limit_choices_to=models.Q(('app_label', 'characters'), ('model__in', ['skill', 'subskill'])), null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='contenttypes.contenttype')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(blank=True)),
                ('skill', models.ForeignKey(help_text='Which Skill this SubSkill falls under', on_delete=django.db.models.deletion.CASCADE, related_name='subskills', to='characters.skill')),
            ],
        ),
        migrations.AddField(
            model_name='classfeature',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('selected_skill_id', models.PositiveIntegerField(blank=True, help_text='(temporarily nullable so migrations can run; you can remove null=True once it’s back-filled)', null=True, verbose_name='Skill or SubSkill ID')),
                ...
                ('selected_skill_type', models.ForeignKey(blank=True, limit_choices_to=models.Q(('app_label', 'characters'), ('model__in', ['skill', 'subskill'])), null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype', verbose_name='Skill or SubSkill type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('selected_skill_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='Skill or SubSkill ID')),
                ...
                ('selected_skill_type', models.ForeignKey(blank=True, limit_choices_to=models.Q(('app_label', 'characters'), ('model__in', ['skill', 'subskill'])), null=True, on_delete=django.db.models.deletion.PROTECT, to='contenttypes.contenttype', verbose_name='Skill or SubSkill type')),
                ('proficiency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='characters.proficiencylevel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='rulebook_page_images/')),
